  ...
  return (
    <div className="text-center">
      <div
        ...
        style={{
          color: "rgba(255,255,255,0.035)", // fill very faint
          WebkitTextStroke: "1.2px rgba(255,255,255,0.18)", // ✅ light border like image
          textShadow:
            "0 1px 0 rgba(0,0,0,0.35), 0 14px 40px rgba(0,0,0,0.25)", // subtle depth
        }}
      >
        {value}
      </div>
