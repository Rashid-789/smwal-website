        ...
        <div className="mt-10 border-t border-white/10 pt-8">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-4">
              <a href="https://youtube.com/@peaceamewowor" target="__blank" aria-label="YouTube" className="opacity-95 hover:opacity-100">
                <YouTubeIcon />
              </a>
              <a href="https://www.facebook.com/@singlemarriedwithalife/" target="__blank" aria-label="Facebook" className="opacity-95 hover:opacity-100">
                <FacebookIcon />
              </a>
              <a href="https://www.instagram.com/singlemarriedwithalife" target="__blank" aria-label="Instagram" className="opacity-95 hover:opacity-100">
                <InstagramIcon />
              </a>
              <a href="https://www.tiktok.com/@theamewowors" target="__blank" aria-label="TikTok" className="opacity-95 hover:opacity-100">
                <TikTokIcon />
              </a>
            </div>
          </div>
